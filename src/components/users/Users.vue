<template>
    <div>
      ...
      <el-card class="box-card">
        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <el-input placeholder="请输入内容" class="input-with-select" v-model="queryInfo.query" @keyup.enter.native="getUserList" clearable>
      ...
      <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed" >
        <el-form label-width="70px" :model="addForm" :rules="addFormRules" ref="addRormRef">
      ...
      <el-dialog title="编辑用户" :visible.sync="editDialogVisible" width="50%" @close="addDialogClosed" >
        <el-form label-width="70px" :model="editForm" :rules="editFormRules" ref="editRormRef">
          <el-form-item label="用户名" prop="username">
