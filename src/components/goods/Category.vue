<template>
    <div>
      ...
      <el-card>
        ...
        <!-- 表格 -->
        <tree-table class="treeTable-top"  :data="catelist" :columns="columns" :selection-type="false" :expand-type="false" show-index index-text="#" border :show-row-hover="false">
          <!-- 是否有效 -->
...
export default {
  ...
  methods: {
    ...
    parentCateChanged() {
      ...
      // selectedKeys 最多只有2个值
      // 如果selectedKeys有值
      // 此商品的父id为selectedKeys的最后一个值
